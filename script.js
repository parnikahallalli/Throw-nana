...
let gameRunning = false;// Monkey Mayhem – Simple version: 3 lives, 2-minute timer, High Score
...
function drawHUD() {
  ...
  // Dark bar behind text so it’s readable
